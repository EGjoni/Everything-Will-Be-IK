...
public class IntList implements Iterable<Integer> {
  ...
  public IntList(Iterable<Object> iter) {
    ...
    for (Object o : iter) {
      if (o == null) {
        ...
        append(StringFuncs.parseInt(o.toString().trim()));
      }
    }
    crop();
  }
    ...
    for (Object o : items) {
      ...
      if (o != null) {
        if (o instanceof Number) {
          ...
          value = StringFuncs.parseInt(o.toString().trim(), missingValue);
        }
      }
      data[index++] = value;
    }
  ...
  private void crop() {
    if (count != data.length) {
      data = StringFuncs.subset(data, 0, count);
    }
  }
...
//  }
   ...
   */
  public void shuffle(StringFuncs sketch) {
    int num = count;
    while (num > 1) {
